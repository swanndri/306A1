...
xterm -geometry 96x24+100-100 -e "source /306A1/se306/devel/setup.bash;cd /306A1/se306/src/package1/;rosrun package1 visitor2.py; read" > /dev/null 2>&1 &
xterm -geometry 96x24-100+100 -e "source /306A1/se306/devel/setup.bash;cd /306A1/se306/src/package1/;rosrun package1 resident2.py; read" > /dev/null 2>&1 &
