...
if("TRUE" STREQUAL "TRUE")
  set(robot_setup_tf_SOURCE_PREFIX /306A1/se306/src/robot_setup_tf)
  set(robot_setup_tf_DEVEL_PREFIX /306A1/se306/devel)
  ...
  set(robot_setup_tf_INSTALL_PREFIX /306A1/se306/install)
...
if(NOT "" STREQUAL "")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir}" STREQUAL "include")
      ...
      message(FATAL_ERROR "Project 'robot_setup_tf' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/306A1/se306/src/robot_setup_tf/${idir}'.  Ask the maintainer 'root <root@todo.todo>' to fix it.")
    endif()
